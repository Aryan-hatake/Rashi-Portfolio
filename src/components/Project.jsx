  ...
  return (
    <div>
      <div className="Project">
        <div className="left">
         <div className="project-cont">
             ...
             <div className="vid-top">
               <video  playsInline preload='none' autoPlay loop muted src="/videos/2.mp4"></video>
             </div>
             <div className="landscape">
              <img loading='lazy' src="/images/15.webp" alt="" />
             </div>
             <div className="vid-bottom">
              <video  playsInline preload='none' autoPlay loop muted src="/videos/1.mp4"></video>
             </div>
             <h2>01</h2>
         </div>
        ...
        <div className="right">
          <div className="story">
          <video autoPlay preload='none' playsInline muted  loop src="/videos/3.mp4"></video>
          </div>
